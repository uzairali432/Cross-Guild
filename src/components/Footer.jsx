...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden bg-card border-t border-border">
      ...
      <div className="relative max-w-7xl mx-auto container-padding py-16">
        {/* Main Footer Content */}
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm text-center md:text-left">
            © {new Date().getFullYear()} Cross Guild. All rights reserved.
          </p>
          <button
            onClick={scrollToTop}
          ...
          >
            Back to top
            <div className="w-8 h-8 rounded-lg bg-muted flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
