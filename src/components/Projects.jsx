  ...
  return (
    <section id="projects" className="section-padding relative overflow-hidden">
      ...
      <div ref={containerRef} className="relative max-w-7xl mx-auto container-padding">
        {/* Section Header */}
        <div className={`text-center mb-12 transition-opacity duration-600 ${isInView ? "opacity-100" : "opacity-0"}`}>
        ...
        {/* Filter Buttons */}
        <div className={`flex flex-wrap justify-center gap-3 mb-12 transition-opacity duration-600 ${isInView ? "opacity-100" : "opacity-0"}`} style={{ transitionDelay: "0.2s" }}>
      ...
      {selectedProject && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-xl animate-scale-in"
